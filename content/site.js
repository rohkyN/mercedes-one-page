...
export const pricing = [
  { t: "12 hodin", k: "100 km v ceně", p: "7 260 Kč" },
  { t: "1 den · 24 hodin", k: "200 km v ceně", p: "12 100 Kč" },
  { t: "Víkend", k: "Pátek 16:00 – neděle 18:00 · 400 km v ceně", p: "19 965 Kč", hot: true, tag: "NEJŽÁDANĚJŠÍ" },
  { t: "3–6 dní", k: "200 km / den v ceně", p: "7 260 Kč / den" },
  { t: "Týden", k: "1 200 km v ceně", p: "34 900 Kč" },
  { t: "Kilometry nad limit", k: "Účtováno při vrácení vozu z kauce", p: "25 Kč / km" },
];
...
export const money = [
  {
    lbl: "Vratná kauce",
    v: "35 000 Kč",
    p: "Převodem nebo hotově při předání vozu. Vracíme do 3 pracovních dnů po předání vozu bez závad.",
  },
  {
    lbl: "Spoluúčast",
    v: "10 %",
    vs: "min. 15 000 Kč",
    p: "Havarijní pojištění je v ceně nájmu.",
  },
  {
    lbl: "Přistavení",
    v: "2 000 Kč",
    p: "Kdekoli v Praze. Vyzvednutí v Říčanech je zdarma.",
  },
];
...
export const included = [
  ...
  "Osobní předání a zaškolení k vozu (cca 10 minut)",
  "Umytý a plně natankovaný vůz při převzetí",
  "Kilometrový limit dle zvoleného balíčku",
];

export const excluded = [
  "Palivo — vůz se vrací s plnou nádrží, benzin 100",
  "Kilometry nad limit (25 Kč / km)",
  "Druhý řidič zapsaný do smlouvy (2 000 Kč)",
...
export const forbidden = [
  ...
  "Jízda mimo zpevněné komunikace.",
];

export const faq = [
  ["Kdy dostanu zpět kauci?", "Do tří pracovních dnů od vrácení vozu, pokud je vůz bez nového poškození a bez nedoplatků za kilometry, palivo nebo pokuty. Kauci přijímáme převodem nebo hotově při předání vozu"],
  ...
  ["Kolik kilometrů mám v ceně?", "200 km na den u denních nájmů, 400 km u víkendového balíčku a 1 200 km u týdenního nájmu. Kilometry nad limit stojí 25 Kč. Pokud dopředu víte, že pojedete dál, domluvíme individuální limit za lepší sazbu."],
  ...
  ["Může řídit i někdo další?", "Ano, pokud splňuje stejné podmínky (25 let, 3 roky praxe) a je zapsán do nájemní smlouvy. Poplatek za druhého řidiče je 2 000 Kč za nájem."],
  ["Jak probíhá předání?", "Osobně, zhruba 15 minut. Sepíšeme předávací protokol s fotodokumentací a stavem tachometru, projdeme ovládání, jízdní režimy a čerpání paliva. Pak vám podáme klíč."],
